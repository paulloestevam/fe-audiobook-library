...
import { IMAGES_URL, DOWNLOADS_URL, API_URL, HOST, GOOGLE_LOGIN_URL } from '../config'
    ...
    <div :class="['controls', { 'dev-env': isDev }]">
      <div class="header-top">
        ...
        <div class="header-links">
          ...
          <a v-if="!isLoggedIn" :href="GOOGLE_LOGIN_URL" class="google-login-btn" title="Entrar com o Google">
